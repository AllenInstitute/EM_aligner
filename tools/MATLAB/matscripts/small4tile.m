...
clc
nfirst= 2316;
nlast = 2316;%setting last=first, because trying to only get 4 tiles in one section
...
rcsource.verbose        = 1;
rcsource.renderbinPath = '/data/nc-em2/gayathrim/Janelia_Pipeline/render/render-ws-java-client/src/main/scripts';
...
rcintermediate.renderbinPath = '/data/nc-em2/gayathrim/Janelia_Pipeline/render/render-ws-java-client/src/main/scripts';
...
rcfine.stack = ['Fine_4tile']
rcfine.owner          ='danielk';
rcfine.project        = 'EM_Phase1_Fine';
